...
function SignupContent() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      // Direct Convex call - matches pre-hardening behavior. /api/auth/signup
      // exists in code but was never deployed.
      ...
      // No localStorage writes here. User must verify email, then sign in.
      setSuccess(true);
    } catch (err: any) {
    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <h1 style={{
          ...
          {success ? (<>Check your <em style={{ fontStyle: "italic" }}>inbox</em>.</>) : (<>Start your <em style={{ fontStyle: "italic" }}>journey</em>.</>)}
        </h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                transition: "opacity 0.15s, transform 0.06s", marginBottom: 14,
              }}
            >
