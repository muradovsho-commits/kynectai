...
export const signIn = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    return { userId: user._id.toString(), name: user.name, outreachCount: user.outreachCount || 0, plan: user.plan || 'free', planActivatedAt: user.planActivatedAt || null, promoCode: user.promoCode || null };
  },
});
