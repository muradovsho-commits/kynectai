...
function SigninContent() {
  ...
  return (
    <div style={{
      ...
      {/* ───────── Top bar: back link on the left, no center wordmark ─────────
          This pattern matches the legal pages (/privacy, /terms, etc.) so
          the auth flow feels continuous with the rest of the public site. */}
      <div style={{
        width: "100%",
        maxWidth: 920,
        marginBottom: 48,
