  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600;700&family=Sora:wght@400;500;600;700&family=Lato:ital,wght@0,300;0,400;0,600;0,700;0,900;1,300;1,400;1,600;1,700&family=Nunito:ital,wght@0,400;0,600;0,700;0,800;0,900;1,600;1,700&family=Nunito+Sans:opsz,wght@6..12,400;6..12,600;6..12,700&display=swap"
          rel="stylesheet"
        />
        <script
