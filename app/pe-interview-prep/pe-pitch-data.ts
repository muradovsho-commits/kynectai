export const PE_PITCH_SECTIONS = [
  {
    title: `13.1 The 4-Part "Investment Committee" Pitch`,
    content: `<p>At some point, the Partner will lean back and ask: <em>"Pitch me a company we should buy right now."</em> If you stumble here, your flawless LBO model means nothing.</p>
<p>Do not pitch a massive public company like Apple or Tesla. Pitch a <strong>middle-market public company or a niche private company</strong> you know well. Structure it exactly like an IC memo.</p>
<h4>1. The Asset & The Moat (What is it and why is it defensible?)</h4>
<p><em>"I am pitching a take-private of [Company X], a $800M enterprise value provider of specialized compliance software for the trucking industry. Their moat is massive: the software is deeply embedded in the dispatchers' daily workflow, resulting in 98% gross retention and high switching costs."</em></p>
