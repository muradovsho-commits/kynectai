            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 320px",gap:"28px",marginBottom:"28px"}}>
              <div>
                <div style={{background:"var(--surface)",border:"1.5px solid var(--border)",borderRadius:"16px",padding:"28px 32px",marginBottom:"20px"}}>
                  <h2 style={{fontFamily:"'Instrument Serif', serif",fontSize:"22px",color:"var(--text)",marginBottom:"10px"}}>Welcome to the PE Interview Guide</h2>
                  <p style={{fontSize:"14px",color:"var(--text-2)",lineHeight:1.7,marginBottom:"20px"}}>This curriculum is crafted by former PE associates and principals from top-tier funds. We've distilled hundreds of case studies and modeling tests into focused modules that mirror real buy-side interviews.</p>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px"}}>
                    {[
                      "Start with Deal Process to build foundational PE knowledge.",
                      "Master LBO math before tackling case studies.",
                      "Practice paper LBOs under timed conditions.",
                      "Tailor behavioral answers with an investor mindset.",
                    ].map((tip, i) => (
