...
<h4>The Math</h4>
<ul>
<li><strong>Entry:</strong> $100M (5x EBITDA of $20M). $30M Equity, $70M Debt.</li>
<li><strong>Operations:</strong> CapEx and NWC are zero → nearly 100% EBITDA-to-FCF conversion. Over 5 years, generates $80M in FCF, wiping out the $70M debt.</li>
<li><strong>Exit:</strong> EBITDA is now $15M. Market values it at 4x (dying business). Exit EV = $60M.</li>
<li><strong>Result:</strong> Debt is $0. Exit Equity = $60M. Turned $30M into $60M = <strong>2.0x MOIC, ~15% IRR</strong> on a business that shrank every year.</li>
</ul>
<p><strong>The Interview Answer:</strong> "Yes, I would LBO a declining business if: (1) the purchase multiple is exceptionally low, (2) FCF conversion is near 100% due to zero CapEx/NWC, and (3) cash generation mathematically outpaces the decline in exit multiple and terminal EBITDA. It becomes a pure deleveraging play."</p>`
  },
  {
    title: `9.2 The Working Capital Peg (The True Purchase Price)`,
...
<p><strong>What interviewers test:</strong> Do you understand that Enterprise Value is theoretical, while the Equity Purchase Price is a fluid number adjusted dollar-for-dollar based on the balance sheet at the exact minute of closing?</p>`
  },
  {
    title: `9.3 Sponsor-to-Sponsor Deals (Secondary Buyouts)`,
    content: `<p><strong>Question:</strong> "If KKR already owned this for 5 years and squeezed out inefficiencies, why would Apollo buy it? Isn't all the meat off the bone?"</p>
