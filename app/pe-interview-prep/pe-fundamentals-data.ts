export const PE_FUNDAMENTALS_SECTIONS = [
  {
    title: `4.1 The Mortgage Analogy`,
    content: `<p>An LBO (Leveraged Buyout) is mechanically identical to buying a house to rent out.</p>
<ol>
<li>You want to buy a $1,000,000 house. You don't use $1M of your own cash.</li>
<li>You put down $200,000 (Equity) and borrow $800,000 (Debt).</li>
<li>Rental income pays the monthly mortgage (Debt Paydown).</li>
<li>Five years later, you sell the house for $1,000,000.</li>
<li>Renters paid off $200,000 of your mortgage. You owe the bank $600,000.</li>
<li>You take the $1M sale price, pay off $600K debt, walk away with $400,000.</li>
<li><strong>The Result:</strong> You doubled your money ($200K to $400K) even though the house value never changed. This is the magic of leverage.</li>
</ol>`
  },
  {
...
<li><strong>Tangible Assets:</strong> Hard assets (real estate, inventory, machinery) can be pledged as collateral, allowing cheaper bank debt.</li>
</ul>`
  },
  {
    title: `4.3 The Three Engines of Value Creation`,
    content: `<p>How does a PE firm generate a 2.5x MOIC?</p>
<ol>
...
<li><strong>Multiple Expansion (Market Timing):</strong> Buying at 8x EV/EBITDA and selling at 10x. Smart PE investors <em>never</em> underwrite assuming multiple expansion — it's too risky to rely on market sentiment.</li>
  ...
  {
    title: `4.4 Why Leverage Increases Returns (And Risk)`,
