...
<p><strong>General Partners (GPs)</strong> are the PE firm itself&mdash;the professionals who source deals, manage portfolio companies, and make investment decisions. GPs have unlimited liability for the fund's obligations and control all investment decisions.</p>
...
<p><strong>Distributions</strong> flow in the opposite direction: as portfolio companies are sold, the GP distributes proceeds to LPs. The timing of distributions is unpredictable&mdash;it depends on when exits occur&mdash;which creates the "J-curve" effect: in early years, cumulative cash flows are negative (capital is being called faster than it's returned), and returns only turn positive as the portfolio matures and exits begin.</p>`,
  },
  {
...
<p>For a $2 billion fund at a 2% fee, the GP collects $40 million per year during the investment period&mdash;regardless of performance. Over a 10-year fund life, total management fees might be $300–400 million, which is a significant cost borne by LPs.</p>
...
<p>GP carry: 20% × $1.03B = <strong>$206M</strong> (with catch-up provisions, the actual calculation is more nuanced&mdash;see below)</p>
...
<p><strong>Tier 1 &ndash; Return of Capital:</strong> LPs receive back 100% of their contributed capital before any profits are distributed.</p>

<p><strong>Tier 2 &ndash; Preferred Return:</strong> LPs receive their preferred return (typically 8% annually) on their contributed capital. This ensures LPs earn a minimum return before the GP profits.</p>

<p><strong>Tier 3 &ndash; GP Catch-Up:</strong> The GP receives 100% of distributions (or sometimes 80/20) until the GP has received 20% of total profits to date. This "catches up" the GP's share so that by the end of the catch-up, the split is 80/20 on total cumulative profits.</p>

<p><strong>Tier 4 &ndash; Carried Interest Split:</strong> Remaining profits are split 80% to LPs and 20% to the GP.</p>
...
<p>GPs are typically required to invest <strong>1–5% of the fund's capital</strong> alongside LPs, funded from partners' personal capital. This "skin in the game" aligns GP interests with LP interests&mdash;the GP team personally benefits from strong returns and suffers from poor ones.</p>`,
  },
  {
    title: 'Fundraising',
    content: `<p>PE firms raise new funds every 3–5 years. The fundraising process involves preparing a <strong>Private Placement Memorandum (PPM)</strong>, conducting a roadshow to meet prospective LPs, and negotiating the <strong>Limited Partnership Agreement (LPA)</strong>&mdash;the legal document governing the fund's terms.</p>
