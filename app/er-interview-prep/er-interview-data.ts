export const ER_INTERVIEW_SECTIONS = [
  {
    ...
    content: `<p>ER interviews typically include: <strong>stock pitch(es)</strong> (almost always&mdash;prepare at least two, one long and one short), <strong>technical questions</strong> (accounting, valuation, financial statement analysis), <strong>market and sector knowledge</strong> (What's happening in your sector? Where is the S&P? What's your view on interest rates?), and <strong>behavioral/fit</strong> (Why ER? Why this sector? Walk me through your resume).</p>
...
<strong>The ER Mindset:</strong> The best equity research analysts share three traits. First, they're genuinely curious about businesses&mdash;they find it intrinsically interesting to understand why a company succeeds or fails, how an industry evolves, and what drives a stock price. Second, they have intellectual honesty&mdash;they change their view when the evidence changes, acknowledge uncertainty, and distinguish between what they know and what they're guessing. Third, they communicate with clarity and conviction&mdash;distilling complex analysis into simple, actionable conclusions that busy investors can use to make decisions. If these traits describe you, you'll thrive in equity research. If they don't, no amount of technical preparation will substitute.
</div>
