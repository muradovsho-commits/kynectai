export const ER_VALUATION_SECTIONS = [
  {
    ...
    content: `<p>Every ER report includes a <strong>target price</strong>-the analyst's estimate of what the stock should be worth in 12 months. The target price is typically derived from one or more valuation methodologies, applied to the analyst's forward estimates.</p>
...
<p>The critical judgment: <strong>what multiple is appropriate?</strong> You determine this by analyzing: the company's historical trading range (has it traded at 15-22x over the past 5 years?), comparable companies' current multiples (peers trade at 16-20x), the company's growth rate relative to peers (faster growers deserve premium multiples), and qualitative factors (management quality, competitive position, earnings visibility).</p>
