...
<p><strong>Fixed vs. Variable:</strong> Fixed costs (rent, salaries, insurance) don't change with volume. Variable costs (raw materials, shipping, sales commissions) scale with volume. If the company's revenue has declined but its cost base hasn't shrunk proportionally, the problem is likely fixed cost leverage&mdash;the company is spreading fixed costs over fewer units, causing per-unit costs to rise.</p>
