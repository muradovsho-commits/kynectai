            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 320px",gap:"28px",marginBottom:"28px"}}>
              <div>
                <div style={{background:"var(--surface)",border:"1.5px solid var(--border)",borderRadius:"16px",padding:"28px 32px",marginBottom:"20px"}}>
                  <h2 style={{fontFamily:"'Instrument Serif', serif",fontSize:"22px",color:"var(--text)",marginBottom:"10px"}}>Welcome to the Consulting Interview Guide</h2>
                  <p style={{fontSize:"14px",color:"var(--text-2)",lineHeight:1.7,marginBottom:"20px"}}>This curriculum is built by former consultants from MBB and top strategy firms. We've condensed years of case prep into structured modules covering frameworks, math, and behavioral preparation.</p>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px"}}>
                    {[
                      "Learn frameworks before jumping into case practice.",
                      "Drill mental math daily for speed and accuracy.",
                      "Practice structuring answers out loud, not just in your head.",
                      "Review behavioral questions with the STAR method.",
                    ].map((tip, i) => (
