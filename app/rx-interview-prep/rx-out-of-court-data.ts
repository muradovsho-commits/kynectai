export const RX_OUT_OF_COURT_SECTIONS = [
  {
    ...
    content: `<p>Filing for Chapter 11 is expensive ($10&ndash;100M+ in professional fees), disruptive (customers and suppliers may flee), time-consuming (months to years), and damaging to the brand. Out-of-court restructurings avoid all of these drawbacks. The RX banker's first objective is always to see if a viable solution exists without involving the court.</p>`,
  },
  {
    title: 'Out-of-Court Tools',
    content: `<h4>Amend and Extend</h4>

<p>The simplest solution: negotiate with existing lenders to push out maturity dates, often in exchange for a modest fee (1&ndash;2% consent fee) and/or a partial paydown. This buys the company time to improve its operating performance or wait for more favorable refinancing conditions. Lenders may agree because receiving par (eventually) beats the alternative of a default where they might recover only 50&ndash;70 cents.</p>

<h4>Exchange Offers</h4>

<p>The company offers existing debt holders the opportunity to exchange their current debt for new securities with different terms. Common exchanges include: old unsecured notes for new secured notes with a lower face value (creditors take a haircut on principal but gain priority), or debt for equity (creditors surrender their debt claims and receive ownership in the company, dramatically reducing leverage). Exchange offers typically require consent from a majority (usually 50&ndash;66.7%) of holders within a class.</p>

<h4>Refinancing</h4>

<p>If the company can access the capital markets, it may issue new debt to repay existing maturities. This works only when lenders are willing to extend new credit&mdash;unlikely if the company is deeply distressed. However, for companies that are merely stressed (not yet in distress), refinancing upcoming maturities can prevent a crisis. The new debt will typically carry a higher coupon to reflect the company's deteriorated credit profile.</p>
