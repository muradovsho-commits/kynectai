...
<p><strong>2. Map the maturity wall:</strong> When does each tranche of debt mature? Are there clusters of maturities coming due soon? Large maturities approaching in 12-24 months that the company likely can't refinance (because its credit is too weak) are the most immediate driver of distress.</p>

<p><strong>3. Calculate leverage and coverage ratios:</strong> Total Debt / EBITDA (leverage), Secured Debt / EBITDA (secured leverage), EBITDA / Cash Interest (interest coverage), and (EBITDA − CapEx) / (Interest + Mandatory Amortization) (fixed charge coverage). Compare these to typical thresholds: secured leverage above 4-5x is concerning; total leverage above 6-7x is distressed territory; interest coverage below 1.5x means the company is barely generating enough cash to pay interest; below 1.0x means it's not covering interest at all.</p>`,
  },
  {
    title: 'What to Look For',
    content: `<p><strong>Trading prices:</strong> Any tranche trading significantly below par is a signal of market concern. A term loan trading below 80 is deeply distressed. Senior unsecured notes trading at 40-60 suggest the market expects significant impairment.</p>

<p><strong>Springing maturities:</strong> Ask whether any senior tranche has a "springer"-a provision that accelerates its maturity if junior debt isn't refinanced by a specified date. Springers can collapse what looks like a comfortable maturity profile into an imminent crisis.</p>
...
<p><strong>Secured basket capacity:</strong> How much additional secured debt can the company issue under its existing credit documents? If the secured basket is nearly full, the company has limited ability to raise new capital at the most senior level-a significant constraint on restructuring options.</p>
