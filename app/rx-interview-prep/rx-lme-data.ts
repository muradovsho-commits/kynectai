...
<p>An uptier involves a company offering a subset of existing creditors the opportunity to exchange their current debt for new, senior-priority debt&mdash;jumping ahead of non-participating creditors in the priority waterfall. The controversy: the non-participating creditors see their effective priority diminished without their consent. This is possible when credit agreements allow the pro-rata sharing provisions (which normally ensure equal treatment of all creditors within a class) to be amended by a simple majority vote.</p>
