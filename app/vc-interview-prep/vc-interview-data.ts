export const VC_INTERVIEW_SECTIONS = [
  {
    ...
    content: `<p>VC interviews are less standardized than banking or PE interviews. Expect: market and sector knowledge ("What's an interesting trend you're following?"), startup evaluation ("Here's a company&mdash;would you invest?"), investment thesis / company pitch ("Tell me about a company you'd invest in"), deal mechanics (term sheets, cap tables, dilution math), and fit/behavioral (Why VC? What have you built? How do you develop conviction?). Some firms also include case studies: you're given a deck from a real startup and asked to present your investment recommendation.</p>`,
  },
  {
    title: 'Questions',
...
<div class="answer">Total invested: $5M (seed) + $3M (Series A pro-rata) = $8M. At exit, the VC owns 20% of $200M = $40M. MOIC: $40M / $8M = 5.0x. For the IRR, we'd need to know the timing: if seed was invested in Year 0, Series A in Year 1, and the exit in Year 4, the cash flows are: Year 0: −$5M, Year 1: −$3M, Year 4: +$40M. Using Excel's XIRR or approximation, the IRR would be roughly 55&ndash;60%. A few nuances: (1) The $40M assumes no additional dilution beyond the Series A. If there was a Series B where the VC didn't participate, their 20% would have diluted further. (2) The liquidation preference doesn't matter here because 20% × $200M = $40M far exceeds the $8M preference, so the VC would convert to common. (3) If the Management Option Pool represents, say, 15% of fully diluted shares and hasn't been accounted for, the VC's effective ownership would be lower (~17%), reducing proceeds to $34M and MOIC to 4.25x.</div>
</div>

<div class="interview-q">
<div class="q-label">Q6</div>
<div class="question">Why venture capital? Why not PE, banking, or starting a company yourself?</div>
<div class="answer">The honest version (adapt to your own story): VC uniquely combines three things I'm drawn to. First, the intellectual breadth&mdash;in a single week you might evaluate a cybersecurity company, a climate tech startup, and a consumer marketplace, each requiring you to rapidly develop conviction on a different technology, market, and team. Second, the relationship with founders&mdash;VC is a partnership, not a transaction. You're backing people at the most uncertain, ambitious moment of their careers, and the best VC relationships last decades. Third, the long feedback loops tied to genuine impact&mdash;unlike trading (where you know your P&L today) or banking (where you advise and move on), VC outcomes play out over 5&ndash;10 years, and the work directly shapes whether transformative companies succeed. I'm not starting a company because I believe my comparative advantage right now is in pattern recognition across many companies, not in operating one. And I chose VC over PE because I'm more energized by the ambiguity and vision of early-stage companies than by optimizing mature businesses.</div>
</div>

<div class="interview-q">
<div class="q-label">Q7</div>
<div class="question">What's the most common mistake VCs make?</div>
<div class="answer">Several good answers: (1) <strong>Pattern matching too rigidly.</strong> Rejecting founders who don't fit the "standard" profile (Ivy League, FAANG, repeat founder) causes VCs to miss outsiders who build the most disruptive companies. The founders of the most transformative companies often don't look like what VCs expect. (2) <strong>Investing in the narrative instead of the evidence.</strong> Charismatic founders can sell a compelling story, but the data (retention curves, unit economics, customer references) tells the truth. The best VCs are skeptical storytellers who verify every claim. (3) <strong>Not investing enough in winners.</strong> The power law means your best investments deserve the most capital. Spreading follow-on capital evenly across the portfolio (instead of concentrating in breakout performers) destroys returns. (4) <strong>Timing error&mdash;being too early.</strong> Many of the best ideas in tech were attempted 5&ndash;10 years before they succeeded (WebVan before Instacart, Pets.com before Chewy). Being early and being wrong look identical in real-time.</div>
</div>`,
  },
  {
    title: 'Common VC Interview Mistakes',
    content: `<div class="mistake-box">
<strong>Not having a company to pitch.</strong> You will be asked about a startup you're excited about. Research 2&ndash;3 early-stage companies in sectors you genuinely find interesting. Know their product, traction, market, team, and why the opportunity is compelling. Bonus points for companies that aren't yet well-known.
</div>

<div class="mistake-box">
<strong>Talking like a banker.</strong> VC interviews reward curiosity, contrarianism, and intellectual range&mdash;not polished corporate-speak. Show genuine passion for technology and startups. Discuss products you use, founders you admire, and trends you follow. If your interview sounds like a banking interview, you haven't adapted.
</div>
...
<div class="mistake-box">
<strong>No point of view on markets.</strong> VC is a thesis-driven business. "I'm interested in everything" signals that you haven't developed conviction about where the best opportunities lie. Pick 2&ndash;3 sectors, develop informed views, and be ready to debate them intelligently.
</div>

<div class="takeaway-box">
<strong>The VC Mindset:</strong> Venture capital is not about avoiding mistakes&mdash;it's about finding outliers. The biggest risk in VC isn't investing in a company that fails; it's <em>not</em> investing in a company that succeeds spectacularly. Every great VC has a portfolio of failures and one or two investments that made everything worthwhile. The skill isn't prediction (no one can predict which startup will be worth $10B); it's pattern recognition&mdash;developing an intuition, through studying hundreds of companies, for which teams, markets, and products have the raw ingredients to become enormous. Start building that pattern recognition now: talk to founders, study startup trajectories, read about how great companies were built in their earliest days, and develop your own theses about where the world is heading. That's the work that separates great VCs from everyone else.
</div>
