...
import { getAuthUserId, unauthorizedResponse, checkRateLimit, getClientIP } from "../_lib/auth";
...
export async function POST(request: NextRequest) {
  ...
  // Rate limit: 20/min
  const limited = checkRateLimit(`enrich:${userId || getClientIP(request)}`, 20, 60_000, {});
