...
<div class="answer">Choose a real example where you had a clear thesis that didn't work out. Explain your original reasoning, what went wrong (was it the thesis, the timing, or an unforeseeable event?), and what you learned. The best answers show intellectual humility and a process improvement: "I was long a specialty retailer because I believed its e-commerce transition was underappreciated. The thesis was right on the revenue side, but I underestimated the margin dilution from fulfillment costs. I learned to stress-test margin assumptions more aggressively and to model the full economics of business model transitions, not just the top line." Never say you've never been wrong&mdash;that signals either inexperience or dishonesty.</div>
</div>

<div class="interview-q">
<div class="q-label">Question 7</div>
<div class="question">Explain the Sharpe Ratio and its limitations.</div>
<div class="answer">The Sharpe Ratio measures risk-adjusted return: (Portfolio Return − Risk-Free Rate) / Portfolio Volatility. It tells you how much excess return you're earning per unit of risk. Higher is better. Limitations: (1) It treats upside and downside volatility equally, but investors care far more about downside volatility (the Sortino Ratio addresses this by using only downside deviation). (2) It assumes returns are normally distributed, which they're not in practice&mdash;real returns have fat tails, and Sharpe doesn't capture tail risk. (3) It can be manipulated by smoothing returns (illiquid strategies like private equity often report lower volatility simply because they mark to market less frequently). (4) It's time-period dependent: a fund with a 2.0 Sharpe over a 3-year bull market may have a 0.5 Sharpe over a full cycle.</div>
</div>
