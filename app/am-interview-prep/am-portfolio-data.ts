...
<p><strong>Benchmark awareness:</strong> Most institutional equity portfolios are measured against a benchmark (S&P 500, MSCI World, Russell 2000). Active decisions are expressed as <strong>overweights</strong> (owning more of a stock or sector than the benchmark) and <strong>underweights</strong> (owning less). The sum of active bets determines <strong>tracking error</strong>&mdash;the volatility of the portfolio's return relative to the benchmark.</p>
