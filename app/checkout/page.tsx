    ...
    return (
      <div style={S.page}>
        <div style={S.card}>
          ...
          <div style={S.sub}>You have full access to all OfferBell features including unlimited outreach messages, Resume Review, AI Coach, and more.</div>
          <div style={S.infoBox}>
          ...
          <div style={{ fontSize: 12, color: "var(--text-3)", marginBottom: 24, lineHeight: 1.6 }}>
            To cancel or update your payment method, manage your subscription through Stripe by contacting us at officialofferbell@gmail.com.
          </div>
          ...
          <div style={{ background: "var(--surface)", border: "1.5px solid var(--border)", borderRadius: 16, padding: 24, marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, fontSize: 13, color: "var(--text-2)" }}>
              {[
                ...
                "AI Resume Review with detailed feedback",
