export const RE_REITS_SECTIONS = [
  ...
  },
  {
    ...
    content: `<p>Because of the high depreciation charges on real estate assets, traditional earnings (EPS, P/E) are meaningless for REITs. Instead, the industry uses:</p>

<div class="formula-box">
FFO = Net Income + Depreciation &amp; Amortization + Losses on Sales − Gains on Sales<br><br>
AFFO = FFO − Recurring CapEx (maintenance) − Straight-Line Rent Adjustments<br><br>
...
<p><strong>NAV (Net Asset Value):</strong> The value of the REIT's properties (estimated using the income approach at market cap rates) plus other assets minus liabilities, divided by shares outstanding. NAV per share represents what the REIT would be worth if it liquidated all properties at market value. REITs trading below NAV may be "undervalued" by the public market; those trading above NAV are at a "premium."</p>

<p><strong>Same-Property NOI Growth:</strong> NOI growth from properties owned for the entire comparison period (excluding acquisitions and dispositions). This is the purest measure of organic operational performance, analogous to same-store sales for retailers.</p>`,
  },
];
