...
<p>You should also understand the difference between <strong>TAM, SAM, and SOM</strong>. TAM is the total market. SAM (Serviceable Addressable Market) is the portion the company can realistically serve given its product, geography, and go-to-market. SOM (Serviceable Obtainable Market) is the realistic near-term capture. A $30B TAM might have a $3B SAM and a $300M SOM for a specific company. The SOM is what matters for near-term revenue projections; the TAM is what matters for long-term potential.</p>

<h4>2. Proven Product-Market Fit</h4>
...
<p>Growth equity companies are often not yet profitable, but they should have a <strong>credible path to profitability</strong>. This means the company's losses are driven by deliberate investment in growth (S&M spending, product development, geographic expansion) that could be dialed back to reveal healthy margins. The company is choosing to reinvest rather than being structurally unprofitable.</p>

<p>Capital efficiency measures how much revenue a company generates per dollar of capital invested. A capital-efficient company might generate $1 of ARR for every $0.60 of capital raised; a capital-inefficient one might require $2+ for the same result. Growth equity firms strongly prefer capital-efficient businesses because they generate higher returns on invested capital and require less dilution.</p>
...
<h4>6. Exceptional Management Team</h4>

<p>In a minority-stake investment with no operational control, the management team <em>is</em> the investment. Growth equity firms evaluate: Has the CEO successfully scaled a company before? Does the team have depth beyond the founder (a CFO who can manage a board, a CRO who can build a sales organization, a CTO who can scale infrastructure)? Is the team coachable and open to input from investors? Are there key-person risks (if the founder leaves, does the company collapse)?</p>

<p>Reference checks are critical. GE firms will speak with former employees, customers, competitors, and other investors to build a 360-degree view of the management team. A brilliant product with a dysfunctional team is not a growth equity investment.</p>
