...
<p><strong>Technical questions (40&ndash;50%):</strong> Unit economics, SaaS metrics, valuation, accounting, GE-specific structuring (liquidation preferences, dilution, preferred stock mechanics). You need to know these cold.</p>

<p><strong>Investment pitch / stock pitch (30&ndash;40%):</strong> Present a company you'd invest in. For GE, this should be a growth-stage private company or a recently public company with GE-like characteristics. Structure it like an IC memo: thesis, market, metrics, risks, valuation, returns.</p>

<p><strong>Behavioral / fit (20&ndash;30%):</strong> Why GE (not VC, not buyout)? Walk me through your resume. Tell me about a time you evaluated a business. What sectors interest you?</p>`,
  },
  {
...
<div class="answer">Growth equity invests in companies that have already proven their business model and achieved meaningful scale (typically $10M&ndash;$200M+ revenue growing 20%+) but need capital to accelerate growth. Unlike VC, the product-market fit is proven and unit economics are established&mdash;the risk is execution and scaling, not product viability. Unlike buyout, GE takes minority positions (20&ndash;40%), uses no leverage, and partners with management rather than replacing them. Returns are driven by revenue growth and margin expansion, not financial engineering. GE sits in the sweet spot of lower loss rates than VC but higher growth potential than buyout.</div>
</div>
...
<div class="answer">GE appeals to me because it combines the analytical rigor of PE (financial modeling, disciplined evaluation, structured deal processes) with the entrepreneurial energy of VC (working with founders building category-defining companies). In VC, much of the investment thesis is based on vision and potential&mdash;you're betting on a team and a market before the product is proven. In buyout, the companies are established but the work is more about optimization than growth. GE offers the best of both: the companies have proven their product and unit economics, so the analysis is grounded in real data, but the growth potential is enormous, so the upside is much larger than a typical buyout. I'm also drawn to the collaborative dynamic: GE investors are partners to management, not controllers, which requires building genuine relationships and trust. And the focus on revenue growth and operating leverage aligns with how I naturally think about businesses.</div>
</div>

<div class="interview-q">
<div class="q-label">Q8</div>
<div class="question">What is the Rule of 40 and how do you use it?</div>
<div class="answer">The Rule of 40 says a healthy software company should have a combined revenue growth rate plus profit margin (typically FCF or EBITDA margin) of at least 40%. A company growing 50% with -10% margins scores 40%&mdash;passing. A company growing 15% with 30% margins scores 45%&mdash;also passing. It captures the trade-off between growth and profitability: it's fine to sacrifice margins for growth (or vice versa) as long as the total exceeds the threshold. In GE, I use it as a quick screening tool: companies consistently above 40% are operating at best-in-class efficiency. Below 20% raises concerns about whether the company can achieve attractive returns. But it's a heuristic, not a rule&mdash;I'd never reject a company solely because it's at 35%, nor invest solely because it's at 50%. The underlying drivers matter more than the composite number.</div>
</div>`,
  },
  {
...
<p><strong>7. Risks and mitigants:</strong> 2&ndash;3 key risks, each with a specific reason why it's manageable.</p>
</div>`,
  },
  {
...
<strong>Mistake 2: Not knowing your metrics.</strong> If you can't define NRR, LTV/CAC, CAC payback, and the Rule of 40 off the top of your head with numerical examples, you're not ready for a GE interview. These aren't nice-to-know&mdash;they're the analytical vocabulary of the job.
</div>
...
<div class="mistake-box">
<strong>Mistake 5: Not having a view on valuation.</strong> "It's a great company" isn't enough. You need a view on what the company is worth, what you'd pay, and what returns that entry price generates across different scenarios. Growth equity is not venture capital&mdash;price discipline matters.
</div>

<div class="takeaway-box">
<strong>The Growth Equity Mindset:</strong> Growth equity investing is fundamentally about finding the rare companies that have cracked the code on their core business and now need fuel to scale. Your job is to separate the companies where growth will compound and create enormous value from the companies where growth is masking unsustainable economics or an eroding competitive position. The metrics in this guide are your tools, but the judgment to weigh them correctly&mdash;to know when 30% growth is more impressive than 60% growth because of how it's achieved, or when a high NRR masks underlying customer dissatisfaction&mdash;is what makes a great GE investor. That judgment comes from reps: analyzing companies, building models, conducting customer calls, and developing pattern recognition across dozens of investments. Start building that pattern recognition now.
</div>
