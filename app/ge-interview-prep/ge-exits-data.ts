...
<p><strong>Secondary Sale / Sponsor-to-Sponsor:</strong> The GE firm sells its stake to another private investor (a later-stage GE firm, a buyout fund, or a sovereign wealth fund). Increasingly common as the private capital ecosystem has grown. Can be executed without company involvement.</p>

<p><strong>Continuation / Recapitalization:</strong> The company raises a new primary round at a higher valuation, and the GE firm sells a portion of its shares in a secondary transaction alongside the primary raise. This provides partial liquidity while allowing the firm to retain upside exposure.</p>`,
  },
  {
    title: 'Return Drivers in GE',
    content: `<p>Unlike buyout PE where returns decompose into leverage, operational improvement, and multiple expansion, GE returns decompose into:</p>
...
<p><strong>Dilution (a return detractor):</strong> Subsequent fundraising rounds dilute the GE firm's ownership percentage, reducing exit proceeds. The impact depends on how many additional rounds are raised and whether the firm exercises pro-rata rights.</p>`,
  },
];
