...
<p><strong>Accounts Receivable (AR):</strong> Amounts owed by customers for goods or services delivered. Reported net of an allowance for doubtful accounts-an estimate of uncollectible amounts. The allowance is one of the most judgment-intensive estimates on the balance sheet. Auditors assess the reasonableness of the allowance by reviewing the aging schedule, historical collection rates, and subsequent collections after year-end.</p>

<p><strong>Inventory:</strong> Goods held for sale or used in production. Under GAAP, inventory is measured at the lower of cost or net realizable value (NRV). Cost flow assumptions-FIFO (first in, first out), LIFO (last in, first out), or weighted-average-determine the cost assigned to goods sold vs. goods remaining. In inflationary environments, LIFO produces lower inventory balances (and higher COGS) than FIFO. Auditors observe physical inventory counts and test the NRV analysis.</p>`,
  },
  {
    title: 'Non-Current Assets',
    content: `<h4>Property, Plant &amp; Equipment (PP&amp;E)</h4>

<p>PP&amp;E is recorded at cost and reduced by accumulated depreciation over its useful life. Key audit considerations include: proper capitalization (distinguishing between capital expenditures that extend useful life vs. repair expenses that merely maintain the asset), impairment testing when indicators exist, and the reasonableness of useful life and salvage value estimates. Asset impairment occurs when the carrying amount exceeds the recoverable amount-a judgment that requires estimating future cash flows and discount rates.</p>

<h4>Goodwill &amp; Intangible Assets</h4>

<p>Goodwill arises from business combinations and represents the excess of purchase price over the fair value of identifiable net assets acquired. Under GAAP, goodwill is not amortized but is tested annually for impairment (or more frequently when triggering events occur). Goodwill impairment is one of the most significant and complex estimates in financial reporting-it requires management to estimate the fair value of a reporting unit, a highly judgmental exercise that auditors must evaluate with specialized valuation knowledge.</p>
...
<p>Accounts payable represents amounts owed to suppliers for goods and services received but not yet paid. Accrued liabilities are obligations that have been incurred but not yet invoiced (accrued wages, accrued interest, warranty reserves). Auditors test for <strong>completeness</strong>-the risk that liabilities are understated or omitted-by reviewing subsequent cash disbursements and searching for unrecorded liabilities.</p>

<h4>Debt &amp; Lease Obligations</h4>

<p>Borrowings must be classified as current (due within one year) or long-term. Debt is typically recorded at amortized cost using the effective interest method, which allocates discount or premium over the debt's life. Under ASC 842, most operating leases appear on the balance sheet as right-of-use assets and corresponding lease liabilities-a significant change that affected the reported leverage ratios of companies with substantial operating leases.</p>
