...
<div class="answer">Audit provides the broadest foundation for understanding how businesses operate because you're looking across the entire financial picture&mdash;not just one area. The exposure to different industries, business models, and management teams in a short time is unmatched. Audit also develops skills&mdash;professional skepticism, structured problem-solving, understanding of accounting standards&mdash;that transfer extremely well to virtually any finance or business role. Advisory and tax are appealing in their own right, but I want to build the fundamental business literacy that audit uniquely provides before specializing.</div>
</div>

<div class="interview-q">
<div class="q-label">Q3</div>
<div class="question">What does an unqualified (clean) audit opinion actually mean?</div>
<div class="answer">It means the auditor obtained sufficient appropriate evidence to conclude that the financial statements are presented fairly, in all material respects, in accordance with the applicable accounting framework (usually GAAP or IFRS). It does not mean the financial statements are perfect or free from all errors&mdash;only that any misstatements are below the materiality threshold. It does not guarantee the company won't fail. It does not mean the auditor found no fraud&mdash;only that any fraud, if present, is not material to the financial statements. The clean opinion is a reasonable assurance conclusion, not a guarantee.</div>
</div>`,
  },
  {
...
<div class="answer">Balance sheet: cash decreases by $100, inventory increases by $100. Net effect on total assets is zero; liabilities and equity are unchanged. Income statement: no effect. The purchase of inventory is not an expense&mdash;it becomes cost of goods sold only when sold. Cash flow statement: cash used in operating activities decreases by $100 (the inventory purchase is an operating outflow if using the direct method, or shown as an increase in inventory reducing operating cash flow in the indirect method). The accounting equation is preserved: assets shift form (cash to inventory) with no change in total.</div>
</div>
...
<div class="answer">The primary risk for AR is overstatement&mdash;management has incentive to inflate receivables (and thus revenue). The key procedures: (1) <em>Confirmation</em>&mdash;send positive confirmations directly to customers asking them to verify the balance owed; this addresses existence and accuracy. (2) <em>Subsequent collections</em>&mdash;verify that receivables recorded at year-end have actually been collected in the subsequent period; this is strong evidence of existence and valuation. (3) <em>Analytical procedures</em>&mdash;calculate days sales outstanding (AR / (Revenue / 365)) and compare to prior years and industry benchmarks; an unexplained increase suggests revenue recognition issues or collectibility concerns. (4) <em>Review of the aging schedule</em>&mdash;assess the reasonableness of the allowance for doubtful accounts; old receivables that haven't been written off inflate the balance. (5) <em>Cutoff testing</em>&mdash;review sales transactions around year-end to ensure revenue is recognized in the correct period.</div>
</div>

<div class="interview-q">
<div class="q-label">Q11</div>
<div class="question">What is goodwill impairment and how is it tested?</div>
<div class="answer">Goodwill impairment occurs when the carrying amount of a reporting unit (including its allocated goodwill) exceeds its fair value. Under ASC 350 (post-2017 simplification), the impairment charge equals the excess of carrying amount over fair value, capped at the carrying amount of goodwill. Testing proceeds in two steps: first, a qualitative assessment ("Step 0") to determine if it's more likely than not that fair value exceeds carrying amount&mdash;if so, no further testing is needed. If not, a quantitative test is performed: estimate the fair value of the reporting unit (typically using discounted cash flow analysis and market multiples), compare to its carrying amount, and record the shortfall as impairment. The DCF requires estimating future cash flows, the terminal growth rate, and the discount rate&mdash;all highly judgmental inputs that auditors must challenge using specialists and sensitivity analysis.</div>
</div>`,
  },
  {
...
<p>The approach: (1) Identify the accounting standard that applies (revenue recognition? leases? business combinations?). (2) Identify the key assertions at risk&mdash;for revenue, it's occurrence and cutoff; for liabilities, it's completeness. (3) Identify the audit procedures that address those assertions most directly&mdash;confirmation, observation, analytical procedures, tests of details. (4) Consider what could go wrong: what is management's incentive, and how might they manipulate this area? (5) Propose mitigating procedures.</p>
