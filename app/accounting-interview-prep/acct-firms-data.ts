...
<p><strong>Risks:</strong> overstated quantities, obsolete or slow-moving inventory, wrong costing, goods in transit cut-off issues, consignment confusion.</p>
...
<h3>8.4 Fixed Assets in Practice</h3>
<p><strong>Risks:</strong> capitalized repairs that should be expensed, missing disposals, incorrect useful lives, depreciation errors, impairment not recognized.</p>
...
<h3>8.6 Going Concern and Completion Procedures</h3>
<p><strong>Going concern:</strong> Can the entity continue operating for a reasonable period under the applicable framework?</p>
<p><strong>Completion procedures include:</strong> subsequent events review, legal letters, management representation letter, final analytics, disclosure checklist review, misstatement evaluation.</p>
<p><strong>Interview insight:</strong> Completion is where the audit is integrated into a final conclusion, not just a pile of tests.</p>
...
<p><strong>Weak answer:</strong> "The income statement shows profit, the balance sheet shows assets and liabilities, and the cash flow statement shows cash."</p>
<p><strong>Follow-ups:</strong> Why can net income differ from cash flow? How do retained earnings change?</p>

<h3>Question 2: What is the difference between accrual and cash accounting?</h3>
<p><strong>Strong answer:</strong> "Cash accounting records transactions when cash is received or paid. Accrual accounting records revenue when earned and expenses when incurred, regardless of cash timing. Accrual accounting is generally more useful for financial reporting because it matches economic activity to the appropriate reporting period."</p>

<h3>Question 3: Why is deferred revenue a liability?</h3>
<p><strong>Strong answer:</strong> "Deferred revenue is a liability because the company has received cash but still owes goods or services to the customer. Until it performs, it has an obligation rather than earned revenue."</p>

<h3>Question 4: Why can depreciation increase cash flow?</h3>
<p><strong>Strong answer:</strong> "Depreciation reduces pre-tax income, which reduces taxes owed, but it does not use cash in the current period, so it is added back on the cash flow statement. That tax shield can increase operating cash flow relative to net income."</p>

<h3>Question 5: What is working capital?</h3>
...
<h3>Question 7: What is materiality?</h3>
<p><strong>Strong answer:</strong> "Materiality is the threshold above which a misstatement or omission could reasonably influence the decisions of users of the financial statements. It has both quantitative and qualitative dimensions."</p>

<h3>Question 8: What are audit assertions?</h3>
<p><strong>Strong answer:</strong> "Audit assertions are management's claims embedded in the financial statements about transactions, balances, and disclosures. Examples include existence, completeness, valuation, rights and obligations, occurrence, cut-off, and classification. Auditors use assertions to design procedures targeted to the risk of misstatement."</p>

<h3>Question 9: Why is revenue often considered a high-risk audit area?</h3>
<p><strong>Strong answer:</strong> "Revenue is often high risk because it is a key performance metric, it can be susceptible to intentional manipulation, and the timing and measurement can be complex, especially where contracts, returns, variable consideration, or cut-off issues are involved."</p>

<h3>Question 10: How would you audit accounts payable completeness?</h3>
<p><strong>Strong answer:</strong> "I would focus on procedures designed to identify unrecorded liabilities, such as reviewing post-year-end cash disbursements, inspecting unmatched receiving reports and vendor statements, and evaluating whether expenses incurred before year-end were recorded in the proper period. Because liabilities are often more likely to be understated than overstated, completeness is the key assertion."</p>

<h3>Question 11: What is the difference between a test of controls and a substantive test?</h3>
<p><strong>Strong answer:</strong> "A test of controls evaluates whether a client control was designed and operated effectively to prevent or detect misstatements. A substantive test is designed to detect misstatements directly, either through tests of details or substantive analytical procedures."</p>

<h3>Question 12: What does professional skepticism mean?</h3>
...
<h3>Question 14: A client's receivables are growing faster than revenue. What might that suggest?</h3>
<p><strong>Strong answer:</strong> "It could suggest slower collections, weaker credit quality, possible channel-stuffing or aggressive revenue recognition, or simply a change in customer payment terms. I would want to analyze aging, subsequent cash receipts, allowance adequacy, and period-end sales patterns."</p>

<h3>Question 15: What would you do if a client explanation does not seem consistent with the evidence?</h3>
<p><strong>Strong answer:</strong> "I would maintain professional skepticism, seek corroborating evidence, discuss the inconsistency with the senior team, and expand testing as appropriate. The key is to resolve the inconsistency with sufficient appropriate evidence rather than relying solely on management explanation."</p>

<h3>Question 16: Why accounting / why audit?</h3>
<p><strong>Strong answer:</strong> "I'm drawn to accounting because it is the discipline that translates complex business activity into structured, decision-useful information. I'm particularly interested in audit because it combines technical accounting, business understanding, risk assessment, and professional judgment. I like work that requires both precision and skepticism, and I find the idea of learning how different businesses operate while evaluating the reliability of their reporting very compelling."</p>

<h3>Question 17: Tell me about a time you found an error or inconsistency.</h3>
