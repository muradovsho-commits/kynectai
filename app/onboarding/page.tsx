...
const VERTICALS: string[] = ["Investment Banking", "Private Equity", "Hedge Fund", "Quantitative Research / Quant Trading", "Venture Capital", "Growth Equity", "Sales & Trading", "Equity Research", "Asset Management", "Consulting", "Accounting / Audit / Tax", "Corporate Finance / FP&A", "Corporate Development", "Real Estate", "Credit / Debt", "Restructuring", "Family Office", "Endowment / Pension"];
              ...
              <div onClick={() => setSelectedPlan("free")} style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16, fontSize: 13.5, flex: 1 }}>
                  {[
                    ...
                    { on: true, text: "Contact Finder \u2014 limited", badge: "SOON" },
