...
const ICONS: Record<string,React.ReactElement> = {
  ...
  quant: <svg viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>,
...
const TRACKS: Track[] = [
  {
    ...
    chapters: [
      ...
      { title:'Networking & Prep', sections:[
        ...
        { title:'Outreach Strategy', content:`<p>Your cold email should be under 100 words, highly personalized, and sent from your .edu address.</p><div class="info-box tip"><div class="info-box-label">Automate the Grind</div>Stop wasting hours searching for emails. Use OfferBell's <strong>Contact Finder</strong> to instantly pull verified email addresses of bankers from any firm. Then, use our <strong>Outreach Writer</strong> to generate hyper-personalized, high-converting cold emails based on your profile and their firm in one click.</div>` },
        { title:'During the Coffee Chat', content:`<p><strong>The Sacred 30-Minute Rule:</strong> NEVER exceed 30 minutes unless they extend. At 25 minutes, mention you want to respect their time.</p><p>Ask insightful questions about their groups, recent deals, and culture. Don't ask questions you could easily Google.</p><div class="info-box tip"><div class="info-box-label">Log Your Interactions</div>Keep track of who replies to what. Log your calls in OfferBell's <strong>Network Tracker</strong> and use <strong>Hit Rate Intel</strong> to see exactly which subject line angles and email formats are statistically proven to get the most replies from bankers.</div>` },
      ]},
    ]
  },
  {
  ...
  },
  {
    ...
    chapters: [
      ...
      { title:'Networking & Prep', sections:[
        ...
        { title:'Outreach Strategy', content:`<p>Consultants appreciate structured communication. Your emails must be MECE (Mutually Exclusive, Collectively Exhaustive) — short, punchy, and clear in their ask.</p><div class="info-box tip"><div class="info-box-label">The Perfect Pitch</div>Find alumni at target firms flawlessly using our <strong>Contact Finder</strong>. Then, ensure your cold email is perfectly structured with OfferBell's <strong>Outreach Writer</strong>, which generates highly professional, succinct asks favored by consultants.</div>` },
        { title:'During the Coffee Chat', content:`<p>Use coffee chats to probe the realities of their staffing model. Ask about their favorite casework. Most importantly, demonstrate your inherent structured thinking in how you construct your questions.</p><div class="info-box tip"><div class="info-box-label">Data-Driven Networking</div>Consultants love data. Use OfferBell's <strong>Hit Rate Intel</strong> to analyze exactly what times of day and subject lines generate the highest response rates from MBB consultants, and track it all via your <strong>Network Tracker</strong>.</div>` },
      ]},
    ]
  },
  {
    id:'quant', title:'Quantitative Finance', sub:'Trading, research, algorithms',
    chapters: [
      { title:'What Is Quant Finance?', sections:[
        { title:'Overview', content:`<p>Quantitative finance applies advanced mathematics, statistics, and computer science to financial markets. Quants work at proprietary trading firms and hedge funds to build algorithms that trade securities automatically, discover market inefficiencies, and systematically manage risk.</p><p>This is arguably the most intellectually rigorous and academically demanding pocket of the global financial sector.</p>` },
        { title:'What They Actually Do', content:`<p>Roles are typically divided into three buckets:</p><ul><li><strong>Quantitative Researchers:</strong> The "scientists." They mine massive datasets to find hidden alpha and build complex predictive models using machine learning and stochastic calculus.</li><li><strong>Quantitative Traders:</strong> Focus on strategy execution, managing live risk, and adapting algorithms to real-time market microstructure changes.</li><li><strong>Quant Developers / SWEs:</strong> Build the ultra-low-latency infrastructure (C++, Rust) that executes the researchers' models in microseconds.</li></ul>` },
        { title:'Firm Tiers & Key Players', content:`<p>The industry splits between Prop Trading (trading the firm's own money) and Quant Hedge Funds (managing outside capital).</p><h4>Proprietary Trading / Market Making</h4><div class="firm-tier"><div class="firm-tier-list"><span class="firm-pill">Jane Street</span><span class="firm-pill">Citadel Securities</span><span class="firm-pill">Hudson River Trading</span><span class="firm-pill">Jump Trading</span><span class="firm-pill">Optiver</span></div></div><h4>Quant Hedge Funds</h4><div class="firm-tier"><div class="firm-tier-list"><span class="firm-pill">Two Sigma</span><span class="firm-pill">Citadel</span><span class="firm-pill">DE Shaw</span><span class="firm-pill">Renaissance Technologies</span><span class="firm-pill">Point72</span></div></div>` },
        { title:'Compensation', content:`<table class="salary-table"><tr><th>Level</th><th>Base</th><th>Bonus</th><th>Total Comp</th></tr><tr><td>Junior QR/Trader</td><td>$150-$250K</td><td>$100-$300K</td><td>$300-$500K+</td></tr><tr><td>Mid-Level</td><td>$250-$400K</td><td>$300K-$1M+</td><td>$600K-$1.5M+</td></tr><tr><td>Senior Portfolio Mgr</td><td>$500K</td><td>Millions</td><td>$2M-$10M++</td></tr></table><p>Quant firms offer the highest straight-out-of-undergrad compensation in the world. Top firms routinely pay new graduates $400k+ total compensation for their first year.</p>` },
        { title:'Culture, Hours & Lifestyle', content:`<p>Hours are generally <strong>50-60 per week</strong>. The culture feels much more like a high-end tech company or an academic math department than a bank. Dress codes are casual (t-shirts are fine), intellectual meritocracy reigns supreme, and your pure coding and math abilities define your worth.</p>` },
      ]},
      { title:'The Recruiting Process', sections:[
        { title:'How Recruiting Works', content:`<p>Firms recruit almost exclusively from top-tier STEM programs. If you don't have a background in CS, Math, Physics, or ML from a target university, getting an interview is notoriously difficult. The process relies heavily on brutal online math/coding assessments.</p>` },
        { title:'Timeline & Pathways', content:`<p>Firms recruit extremely early. Summer internship applications for Jane Street, Citadel, etc., frequently open in the early summer <em>a full year prior</em> to the internship. They also aggressively hire PhDs throughout the year off-cycle.</p>` },
        { title:'The Interview Process', content:`<p>Expect some of the hardest interviews of your life. You will be grilled on probability theory, brainteasers, Python/C++ data structures, and mental math. Answering correctly isn't enough; you must answer optimally and quickly.</p><div class="info-box tip"><div class="info-box-label">Sharpen Your Edge</div>Beat the brutal math tests by running unlimited mock quantitative interviews using OfferBell's <strong>AI Coach</strong>. Configure the Coach to drill you on expected value, probability matrices, and statistical paradoxes.</div>` },
      ]},
      { title:'Networking & Prep', sections:[
        { title:'Why Networking Matters', content:`<p>In quant, your resume and test scores matter far more than coffee chats. However, connecting with researchers can provide invaluable referrals that jump you past the automated screen algorithms.</p>` },
        { title:'Outreach Strategy', content:`<p>Reach out to alumni on the research teams, but keep it strictly intellectual. Do not send generic business networking pitches. Instead, mention a specific statistical model, paper they wrote, or programming challenge.</p><div class="info-box tip"><div class="info-box-label">Find the Engineers</div>Use OfferBell's <strong>Contact Finder</strong> to pull real emails for notoriously elusive quant researchers. Leverage the <strong>Outreach Writer</strong> to craft concise, highly technical emails that won't get instantly archived.</div>` },
        { title:'During the Coffee Chat', content:`<p>Expect them to test you even during a casual chat. If you mention you built an options pricer, expect a follow up about Black-Scholes Greeks. Treat the coffee chat as a pre-interview.</p><div class="info-box tip"><div class="info-box-label">Data is King</div>Quants respect data. In your own recruiting, demonstrate operational efficiency by managing your pipeline through OfferBell's <strong>Network Tracker</strong> and calibrating your outreach using <strong>Hit Rate Intel</strong>.</div>` },
      ]},
    ]
  },
  {
    ...
    chapters: [
      ...
      { title:'Networking & Prep', sections:[
        ...
        { title:'Outreach Strategy', content:`<p>Be persistent. Growth equity professionals respect the hustle more than anyone else because they do it themselves every day.</p><div class="info-box tip"><div class="info-box-label">Outsource the Friction</div>Use OfferBell's <strong>Contact Finder</strong> to pull direct emails for analysts and associates at top Growth funds. Automatically draft highly personalized cold emails with our <strong>Outreach Writer</strong>, allowing you to scale your networking like a pro.</div>` },
        { title:'During the Coffee Chat', content:`<p>Come prepared with ideas. Do not just ask about their career; pitch them a thesis. "I've been looking at the vertical SaaS space for construction, have you guys looked at Company X?"</p><div class="info-box tip"><div class="info-box-label">Track Every Touchpoint</div>Your network is your funnel. Keep rigorous tabs of your follow-ups using OfferBell's <strong>Network Tracker</strong> and leverage <strong>Hit Rate Intel</strong> to continuously optimize your reply rates.</div>` },
      ]},
    ]
  },
  {
    ...
    chapters: [
      ...
      { title:'Networking & Prep', sections:[
        ...
        { title:'Outreach Strategy', content:`<p>Reach out to junior analysts covering sectors you find interesting. Attach a 1-page stock writeup to show you actually know how to do the work.</p><div class="info-box tip"><div class="info-box-label">The Edge in Access</div>Use OfferBell's <strong>Contact Finder</strong> to instantly access direct emails for researchers at Vanguard, Fidelity, and boutique shops. Let the <strong>Outreach Writer</strong> format your introduction perfectly so you can focus on building your actual stock pitch.</div>` },
        { title:'During the Coffee Chat', content:`<p>Ask about their investment philosophy. Talk about the markets. If the S&P dropped 2% yesterday, you better have a reasoned opinion on why.</p><div class="info-box tip"><div class="info-box-label">Analytics for the Buy-Side</div>Treat your networking like your portfolio. Monitor your hit rates and success metrics across different funds efficiently with OfferBell's <strong>Network Tracker</strong> and <strong>Hit Rate Intel</strong>.</div>` },
      ]},
    ]
  },
  {
